...
<div class="card-body">
    ...
    <button wire:click.prevent="update({{$homeSite_id}})" class="btn btn-primary" data-bs-toggle="collapse" data-bs-target="#collapseExample" aria-expanded="false" aria-controls="collapseExample">Atualizar</button>
